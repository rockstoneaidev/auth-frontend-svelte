...
### Added
- Added support for Authenticator App (TOTP/QR Code) multi-factor authentication.
- New `MfaTotpSetupForm` component for easy app-based MFA enrollment.
- Updated `MfaSetupForm` to support method selection.
- Updated `MfaChallengeForm` to support multiple second factors (TOTP and SMS).
